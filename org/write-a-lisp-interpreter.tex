...
\section{实现一个解释器}
<<<<<<< HEAD
\label{sec:orgc6afbdc}
\begin{frame}[label={sec:orgd8f1a2b}]{声明}
...
<<<<<<< HEAD
\begin{frame}[label={sec:org01945eb},fragile]{\texttt{eval-if}}
=======
...
\end{frame}
<<<<<<< HEAD
\begin{frame}[label={sec:orgc6361b8},fragile]{\texttt{eval-quote}}
=======
...
\end{frame}
<<<<<<< HEAD
\begin{frame}[label={sec:org42c8c71},fragile]{\texttt{eval-lambda}}
=======
